...
<body>
    ...
    <!-- 404 Start -->
    <div class="container-xxl py-6 wow fadeInUp" data-wow-delay="0.1s" style="margin-top: 50px;">
        <div class="container text-center">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    ...
                    <p class="mb-4">Mohon maaf keranjang kosong / tidak ada, Anda harus login terlebih dahulu untuk
                        melakukan transaksi.</p>
                    <a class="btn btn-primary rounded-pill py-3 px-5" href="index.php">Kembali Ke Beranda</a>
                </div>
            </div>
        </div>
    </div>
