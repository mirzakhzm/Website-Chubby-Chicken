...
<body>
    ...
    <!-- Contact Start -->
        <div class="container">
            <div class="text-center mx-auto mb-10 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <p class="text-primary text-uppercase mb-4">// Kontak</p>
                <h1 class="display-6 mb-4">Kritik dan Saran</h1>
            </div>
            <div class="row g-0 justify-content-center">
                <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.1s">
                    <p class="text-center mb-4">Setiap Feedback, Kritik atau Saran Akan Mendapatkan Apresiasi Dari Kami, Berupa Diskon Sebesar 20%</p>
                    <p class="text-center mb-4">Kami akan menghubungi Anda kembali dalam 2 hari kerja. 
                        Kepuasan pelanggan adalah yang paling penting bagi kami dan jika kami belum memenuhi harapan Anda dengan cara apa pun,
                        kami ingin melakukan apa yang kami bisa agar Anda kembali sebagai pelanggan kami
                    </p>
                    <form action="simpancontact.php" method="POST">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea class="form-control" name="pesan" placeholder="Leave a message here" id="message" style="height: 200px"></textarea>
                                    <label for="message">Message</label>
                                </div>
                            </div>
                            <div class="col-12 text-center">
                                <button class="btn btn-primary rounded-pill py-3 px-5" name="submit" value="simpan" type="submit">Kirim</button>
                            </div>
                        </div>
                    </form>
                </div>
