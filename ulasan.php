...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
        ...
        <div class="navbar-nav mx-auto p-4 p-lg-0">
                ...
                <a href="ulasan.php" class="nav-item nav-link active">Ulasan</a>
        ...
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                <div class="testimonial-item bg-white rounded p-4">
                    ...
                    <p class="mb-0">Untuk Rasa Emang Super Enak Bangett, Sangking Enak nya Setiap Beli kesini Selalu Antri.</p>
                </div>
                <div class="testimonial-item bg-white rounded p-4">
                    <div class="d-flex align-items-center mb-4">
                    ...
                    <p class="mb-0">Taiwan street snack yang enak, ada pilihan ayam, dori, cumi dll dengan kisaran harga yang murah.</p>
                </div>
                <div class="testimonial-item bg-white rounded p-4">
                    <div class="d-flex align-items-center mb-4">
                    ...
                    <p class="mb-0">Snack ayam tepung favorit, crunchy, tasty, pilihan rasanya banyak. Harga sipp bgt.</p>
                </div>
                <div class="testimonial-item bg-white rounded p-4">
                    <div class="d-flex align-items-center mb-4">
                    ...
                    <p class="mb-0">Favourite ayam ala ala taiwan street!!! Masaknya tuh selalu pas jadi rasa ayamnya masih terasa. Bumbunya bisa mix sesuka hati. Recommended polll.</p>
                </div>
            </div>
        </div>
    </div>
