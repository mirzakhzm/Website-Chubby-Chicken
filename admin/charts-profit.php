    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Total Profit Setiap Tahun</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        ...
        <div class="col-lg-10">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Total Profit Setiap Tahun</h5>
                    ...
                    tooltip: {
                      y: {
                        formatter: function (value) {
                          return new Intl.NumberFormat('id-ID').format(value); // Memberikan tanda titik sebagai pemisah ribuan
                        }
                      }
                    }
                  }).render();
