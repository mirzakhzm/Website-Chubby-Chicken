...
<body>
  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
      <div class="row">
        <h2>Selamat datang di Dashboard Admin Chubby Chicken</h2>
        <p>Ini adalah halaman dashboard yang berisi informasi penting tentang pesanan Anda.</p>
        <!-- Elemen-elemen lain yang relevan -->
      </div>
    </section>
