...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
        ...
        <div class="navbar-nav mx-auto p-4 p-lg-0">
                ...
                <a href="location.php" class="nav-item nav-link active">Lokasi</a>
    ...
    <div class="container-fluid p-0 pb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="owl-carousel header-carousel position-relative">
            ...
            <h1 class="display-4 text-white animated slideInDown mb-3">Lokasi</h1>
                    <nav aria-label="breadcrumb animated slideInDown">
                        <ol class="breadcrumb justify-content-center mb-0">
                            <li class="breadcrumb-item"><a class="text-white" href="userpage.php">Beranda</a></li>
                            <li class="breadcrumb-item text-primary active" aria-current="page">Lokasi</li>
                         </ol>
                    </nav>
                </div>
            </div>
    ...
    <!-- Location Start -->
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <p class="text-primary text-uppercase mb-2">// Lokasi</p>
                <h1 class="display-6 mb-4">Outlet Terdekat</h1>
            </div>
        </div>
    <div class="container-xxl py-4 px-0 wow fadeInUp" data-wow-delay="0.1s">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d126633.
        40276263242!2d112.77078709999999!3d-7.
        320854!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.
        1!3m3!1m2!1s0x2dd7fb92e57966db%3A0x612c254b5821af5c!2sCHUBBY!5e0!3m2!1sen!2sid!4v1686015506686!5m2!1sen!2sid"
        width= "1300" height= "480" style=" border: 3px solid #333;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe> 
        </div>
        <!-- Location End -->
